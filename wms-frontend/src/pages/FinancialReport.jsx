            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                    <p className="text-sm text-gray-700">
                        Menampilkan <span className="font-medium">{(currentPage - 1) * PRODUCT_SUMMARY_LIMIT + 1}</span> -{' '}
                        <span className="font-medium">{Math.min(currentPage * PRODUCT_SUMMARY_LIMIT, totalPages * PRODUCT_SUMMARY_LIMIT)}</span> dari{' '}
                        <span className="font-medium">{totalPages * PRODUCT_SUMMARY_LIMIT}</span> hasil
                    </p>
                </div>
                <div>
...
function FinancialReport() {
    ...
    const baseReportUrl = `/api/reports/financial?startDate=${appliedFilters.startDate || ''}&endDate=${appliedFilters.endDate || ''}&summaryPage=${summaryPage}&summaryLimit=${PRODUCT_SUMMARY_LIMIT}`;
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-4">Terjadi kesalahan saat mengambil data laporan keuangan.</p>
                    <button 
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">Analisis lengkap performa keuangan dan valuasi inventory</p>
                    </div>
                    <button 
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <StatCard
                        ...
                        subtitle={`${formatNumber(valuation?.total_units_in_stock)} unit dalam stok`}
                        color="purple"
                    />
                    ...
                    <StatCard
                        ...
                        subtitle={isPositiveProfit ? "Performa positif" : "Performa negatif"}
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-200">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            <div>
                                <h2 className="text-xl font-bold text-gray-900">Ringkasan Nilai Stok Produk</h2>
                                <p className="text-gray-600 mt-1">Detail valuasi inventory per produk</p>
                            </div>
                            <div className="text-sm text-gray-500">
                                Total: <span className="font-semibold text-gray-900">{summaryTotalCount} produk</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">HPP Rata-rata</th>
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Stok</th>
                                    <th className="px-6 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Nilai</th>
                                </tr>
                            </thead>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 text-center">
                    <p className="text-gray-600 text-sm">
                        Laporan terakhir diperbarui: {new Date().toLocaleDateString('id-ID', { 
                            weekday: 'long', 
                            year: 'numeric', 
                            month: 'long', 
                            day: 'numeric',
